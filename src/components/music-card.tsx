...
export default function MusicCard() {
	...
	const position = useMemo(() => {
		...
		return {
			x: styles.offsetX !== null ? center.x + styles.offsetX : center.x + CARD_SPACING + hiCardStyles.width / 2 - (styles.offset ?? 120),
			y: styles.offsetY !== null ? center.y + styles.offsetY : center.y - (clockCardStyles.offset ?? 92) + CARD_SPACING + calendarCardStyles.height + CARD_SPACING
		}
