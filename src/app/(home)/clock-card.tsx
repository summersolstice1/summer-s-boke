...
export default function ClockCard() {
	...
	useEffect(() => {
		...
		const schedule = () => {
			...
			const delay = showSeconds ? 1000 - now.getMilliseconds() : (60 - now.getSeconds()) * 1000 - now.getMilliseconds()
			timer = window.setTimeout(schedule, Math.max(delay, 250))
		}
	...
	const y = styles.offsetY !== null ? center.y + styles.offsetY : center.y - (styles.offset ?? 92) - styles.height
