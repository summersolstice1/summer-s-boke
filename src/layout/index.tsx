...
import PlanetaryBackdrop from './backgrounds/planetary-backdrop'
import ThemeToggle from '@/components/theme-toggle'
import CatOpening from '@/components/cat-opening'
	...
	return (
		<>
			...
			{currentBackgroundImage && (
				<div
					className='fixed inset-0 z-0 overflow-hidden opacity-30 mix-blend-soft-light'
					style={{
			...
			<main className='relative z-10 h-full'>
				{children}
				{cardStyles.navCard?.enabled !== false && <NavCard />}
				<ThemeToggle />
